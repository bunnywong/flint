...
function thegem_register_required_plugins() {
	$plugins = array(
		array(
			...
			'source' => esc_url('http://dl.gplnulls.com/thegem/thegem-elements.zip'),
			'required' => true,
			'version' => '',
		...
		array(
			...
			'slug' => 'thegem-import',
			'source' => esc_url('http://dl.gplnulls.com/thegem/thegem-import.zip'),
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug' => 'LayerSlider',
			'source' => esc_url('http://dl.gplnulls.com/thegem/LayerSlider.zip'),
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug' => 'revslider',
			'source' => esc_url('http://dl.gplnulls.com/thegem/revslider.zip'),
			'required' => false,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug' => 'js_composer',
			'source' => esc_url('http://dl.gplnulls.com/thegem/js_composer.zip'),
			'required' => true,
			'version' => '',
			'force_activation' => false,
			'force_deactivation' => false,
		...
		array(
			...
			'slug' => 'zilla-likes',
			'source' => esc_url('http://dl.gplnulls.com/thegem/zilla-likes.zip'),
			'required' => false,
			'version' => '1.1.1',
			'force_activation' => false,
			'force_deactivation' => false,
