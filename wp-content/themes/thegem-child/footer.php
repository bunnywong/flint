...
?>
		...
		<?php if(!$effects_params['effects_page_scroller'] && !$effects_params['effects_hide_footer']) : ?>
			...
			<footer id="colophon my-hide" class="site-footer" role="contentinfo">
				<div class="container">
			...
			<footer id="footer-nav" class="site-footer">
				<div class="container"><div class="row">
					...
					<div class="col-sm-3 footer-left-wrapper"><div class="footer-site-info"><?php echo wp_kses_post(do_shortcode(nl2br(stripslashes(thegem_get_option('footer_html'))))); ?></div></div>
