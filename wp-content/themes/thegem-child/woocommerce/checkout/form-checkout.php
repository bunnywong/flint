...
<?php if ($thegem_checkout_type == 'multi-step'): ?>
	<div class="hide checkout-steps <?php if(is_user_logged_in()): ?>user-logged<?php endif; ?> clearfix">
...
<?php if ($thegem_checkout_type == 'one-page'): ?>
	<div class="my-hide checkout-steps clearfix woocommerce-steps-<?php echo $thegem_checkout_type; ?>">
