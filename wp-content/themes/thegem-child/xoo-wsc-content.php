	...
	<div class="xoo-wsc-content">
		...
		<?php else: ?>
          ...
          <div class="xoo-wsc-product row m0" data-xoo_wsc="<?php echo $cart_item_key; ?>">
            <div class="col-xs-2 bag__remove">
              <a href="#" class="xoo-wsc-remove">
              <img src="/wp-content/uploads/2018/06/close_icon.png">
            </a>
            </div>
            ...
            <div class="col-xs-4 _line-total text-right"><?php echo $product_subtotal; ?></div>
					...
					<!-- <div class="xoo-wsc-product" data-xoo_wsc="<?php echo $cart_item_key; ?>">
						<div class="xoo-wsc-img-col">
							...
							<a href="#" class="xoo-wsc-remove">x<?php //_e('Remove','side-cart-woocommerce'); ?></a>
						</div>
